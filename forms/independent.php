...
<head>
    <meta charset="UTF-8">
    <title>Déclaration Indépendant</title>
...
<div class="container">
    <h2>📄 Formulaire de déclaration – Indépendant</h2>

    <!-- Sélection du déclarant -->
    <form method="GET" action="independent.php" style="margin-bottom: 20px;">
    ...
    <!-- Formulaire fiscal -->
    <form method="POST" action="submit_independent.php">
        ...
        <label for="income">💼 Revenu net :</label>
        <input type="number" step="0.01" name="income" id="income" required min="0" placeholder="Ex: 18000.00">

        <label for="expenses">📉 Dépenses professionnelles :</label>
        <input type="number" step="0.01" name="expenses" id="expenses" min="0" placeholder="Ex: 3000.00">

        <label for="dependents">👨‍👩‍👧 Personnes à charge :</label>
        <input type="number" name="dependents" id="dependents" min="0" max="10" placeholder="Ex: 1">
